...
<div class="mb-3">
  <label for="nama_maskapai" class="form-label" style="color: #31c490;"><strong>Nama Maskapai</strong></label>
  <input type="text" class="form-control" name="nama_maskapai" id="nama_maskapai" placeholder="Ketik nama maskapai...">
</div>
<div class="my-3">
<label for="bandara_asal" class="form-label" style="color: #31c490;"><strong>Bandara Asal</strong></label>
...
<div class="my-3">
<label for="bandara_tujuan" class="form-label" style="color: #31c490;"><strong>Bandara Tujuan</strong></label>
...
<div>
  <label for="Harga Tiket" class="form-label" style="color: #31c490;"><strong>Harga Tiket</strong></label>
</div>
<div class="row g-2">
<div class="col-auto">
